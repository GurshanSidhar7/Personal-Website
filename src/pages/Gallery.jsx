...
export default function Gallery() {
  const images = [
    ...
    { src: "/gallery_image/bird_sun.jpg", title: "Ball of Fire", description: "It's like the birds are flocking around the warmth of the sun.", spotifyLink: "https://open.spotify.com/track/4wajJ1o7jWIg62YqpkHC7S?si=9bb46ea68e3b49a6" },
    { src: "/gallery_image/dark_ryd.jpg", title: "Dark Ryd", description: "The red light shinge like a ruby in a ocean of blue skies", spotifyLink: "https://open.spotify.com/track/3EaJDYHA0KnX88JvDhL9oa?si=b53cf178439a45bb" },
    ...
    { src: "/gallery_image/jellyfish.JPG", title: "Floating Away", description: "Fun Fact: They’re older than dinosaurs!", spotifyLink: "https://open.spotify.com/track/7o2AeQZzfCERsRmOM86EcB?si=ad6e121d01004345" },
      ...
      <div className="gallery-content">
        ...
        <div className="gallery-grid">
          {images.map((image, index) => (
            <a key={index} href={image.spotifyLink} target="_blank" rel="noopener noreferrer" className={`gallery-item ${index % 2 === 0 ? 'left' : 'right'}`}>
